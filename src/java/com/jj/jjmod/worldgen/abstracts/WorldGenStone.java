...
public abstract class WorldGenStone extends WorldGenAbstract {
    ...
    protected void generateVein(int x, int y, int z) {
        ...
        double d0 = (double) ((float) (x + 8) + MathHelper
                .sin(f) * (float) veinSize / 8.0F);
        double d1 = (double) ((float) (x + 8) - MathHelper
                .sin(f) * (float) veinSize / 8.0F);
        double d2 = (double) ((float) (z + 8) + MathHelper
                .cos(f) * (float) veinSize / 8.0F);
        double d3 = (double) ((float) (z + 8) - MathHelper
                .cos(f) * (float) veinSize / 8.0F);
        double d4 = (double) (y + this.rand.nextInt(3) - 2);
        double d5 = (double) (y + this.rand.nextInt(3) - 2);
        ...
        for (int i = 0; i < veinSize; ++i) {
            ...
            double d9 = this.rand.nextDouble() * (double) veinSize / 16.0D;
            double d10 = (double) (MathHelper
                    .sin((float) Math.PI * f1) + 1.0F) * d9 + 1.0D;
            double d11 = (double) (MathHelper
                    .sin((float) Math.PI * f1) + 1.0F) * d9 + 1.0D;
