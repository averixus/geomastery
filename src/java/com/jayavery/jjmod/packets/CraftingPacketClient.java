...
public class CraftingPacketClient implements IMessage {
    ...
    public CraftingPacketClient() {}
    
    public CraftingPacketClient(int durability, BlockPos pos) {
    ...
    public static class Handler implements
            IMessageHandler<CraftingPacketClient, IMessage> {
        
        @Override
        public IMessage onMessage(CraftingPacketClient message,
                MessageContext ctx) {
        ...
        public void processMessage(CraftingPacketClient message) {
