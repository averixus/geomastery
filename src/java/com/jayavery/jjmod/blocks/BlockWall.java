...
import com.jayavery.jjmod.utilities.UnlistedPropertyWall;
...
public abstract class BlockWall extends BlockBuilding
        implements IDelayedMultipart, IDoublingBlock, Comparable<BlockWall> {
    ...
    /** Stores this instance's renderer. */
    protected WallRenderer renderer;
    ...
    @Override
    public abstract WallRenderer getLoader();
