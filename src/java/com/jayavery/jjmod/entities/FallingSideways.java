...
public class FallingSideways extends Entity
{
    private IBlockState fallTile = ModBlocks.test.getDefaultState();
    public int fallTime;
    ...
    public FallingSideways(World worldIn)
    {
        super(worldIn);
    }

    public FallingSideways(World worldIn, double x, double y, double z, IBlockState fallingBlockState)
    {
        super(worldIn);
