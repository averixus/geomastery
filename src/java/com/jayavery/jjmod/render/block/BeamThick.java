...
public class BeamThick extends DelayedBakingAbstract {
    ...
    public List<BakedQuad> getQuads(IBlockState state,
        ...
        if (axis == EnumAxis.NS) {
            ...
            this.addQuads(result, thickMiddle, 90, state, facing, rand);
            
        } else {
            
            this.addQuads(result, thickMiddle, state, facing, rand);
        }
        ...
        if (front) {
            ...
            if (axis == EnumAxis.NS) {
                ...
                this.addQuads(result, thickEnd, 270, state, facing, rand);
                
            } else {
                
                this.addQuads(result, thickEnd, state, facing, rand);
            }
        }
        ...
        if (back) {
            ...
            if (axis == EnumAxis.NS) {
                ...
                this.addQuads(result, thickEnd, 90, state, facing, rand);
                
            } else {
                
                this.addQuads(result, thickEnd, 180, state, facing, rand);
            }
        }
    ...
    public static class Loader implements ICustomModelLoader {
        ...
        public boolean accepts(ResourceLocation loc) {
            ...
            return loc instanceof ModelResourceLocation &&
                    ...
                    ModBlocks.beamThick.getRegistryName().equals(loc);
        }
        ...
        public IModel loadModel(ResourceLocation modelLocation)
            ...
            thickMiddle = thickMiddle == null ?
                    model("thick/middle") : thickMiddle;
            thickEnd = thickEnd == null ? model("thick/end") : thickEnd;
