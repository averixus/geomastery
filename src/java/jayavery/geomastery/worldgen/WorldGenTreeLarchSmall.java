...
public class WorldGenTreeLarchSmall extends WorldGenTreeAbstract {

    public WorldGenTreeLarchSmall(World world, Random rand, boolean isSapling) {
    ...
    private boolean generateTreeB(BlockPos stump) {
        ...
        if (this.rand.nextInt(2) == 0) {
            ...
            this.setBlock(stump.up(layer), GeoBlocks.TREE_SMALL.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.LARCH));
            layer++;            
        }
