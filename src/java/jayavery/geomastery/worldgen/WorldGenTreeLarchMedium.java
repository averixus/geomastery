...
public class WorldGenTreeLarchMedium extends WorldGenTreeAbstract {

    public WorldGenTreeLarchMedium(World world, Random rand, boolean isSapling) {
    ...
    public boolean generateTree(BlockPos stump) {
        ...
        int layerCount = this.rand.nextInt(6) + 5;
        ...
        this.setBlock(stump, GeoBlocks.STUMP_MEDIUM.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.LARCH));
        
        for (BlockPos trunk : trunks) {
            
            this.setBlock(trunk, GeoBlocks.TREE_MEDIUM.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.LARCH));
        }
