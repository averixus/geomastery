...
// TEST
public class WorldGenTreeOakSmall extends WorldGenTreeAbstract {

    public WorldGenTreeOakSmall(World world, Random rand, boolean isSapling) {
    ...
    private boolean generateTreeA(BlockPos stump) {
        ...
        for (BlockPos trunk : trunks) {
            ...
            this.setBlock(trunk, GeoBlocks.TREE_SMALL.getDefaultState());
        }
