...
// copy from larch
public class WorldGenTreePineSmall extends WorldGenTreeAbstract {
    
    public WorldGenTreePineSmall(World world, Random rand, boolean isSapling) {
    ...
    private boolean generateTreeB(BlockPos stump) {
        ...
        if (this.rand.nextInt(2) == 0) {
            ...
            this.setBlock(stump.up(layer), GeoBlocks.TREE_SMALL.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.PINE));
            layer++;            
        }
