...
public class WorldGenTreePineLarge extends WorldGenTreeAbstract {

    public WorldGenTreePineLarge(World world, Random rand, boolean isSapling) {
    ...
    public boolean generateTree(BlockPos stump) {
        ...
        int trunkCount = this.rand.nextInt(6) + 12;
        ...
        this.setBlock(stump, GeoBlocks.STUMP_LARGE.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.PINE));
        
        for (BlockPos trunk : trunks) {
            
            this.setBlock(trunk, GeoBlocks.TREE_LARGE.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.PINE));
        }
        ...
        for (; layer < trunkCount; layer++) {
            ...
            if (layer < 9) {
                ...
                this.cross(start.down(layer), 3, leaves);
