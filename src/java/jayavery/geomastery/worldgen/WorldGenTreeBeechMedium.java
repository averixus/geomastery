...
// TEST
public class WorldGenTreeBeechMedium extends WorldGenTreeAbstract {

    public WorldGenTreeBeechMedium(World world, Random rand, boolean isSapling) {
...
//            case 0:
  ...
  //          case 1: default:
    ...
    private boolean generateTreeA(BlockPos stump) {
        ...
        this.setBlock(stump, GeoBlocks.STUMP_MEDIUM.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.BEECH));
        
        for (BlockPos trunk : trunks) {
            
            this.setBlock(trunk, GeoBlocks.TREE_MEDIUM.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.BEECH));
        }
