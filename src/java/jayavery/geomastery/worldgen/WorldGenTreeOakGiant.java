...
public class WorldGenTreeOakGiant extends WorldGenTreeAbstract {

    public WorldGenTreeOakGiant(World world, Random rand, boolean isSapling) {
    ...
    public boolean generateTree(BlockPos stump) {
        ...
        for (BlockPos trunk : trunks) {
            ...
            this.setBlock(trunk, GeoBlocks.TREE_GIANT.getDefaultState());
        }
