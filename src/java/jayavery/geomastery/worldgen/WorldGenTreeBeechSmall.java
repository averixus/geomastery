...
// TEST
public class WorldGenTreeBeechSmall extends WorldGenTreeAbstract {

    public WorldGenTreeBeechSmall(World world, Random rand, boolean isSapling) {
    ...
    private boolean generateTreeA(BlockPos stump) {
        ...
        for (BlockPos trunk : trunks) {
            ...
            this.setBlock(trunk, GeoBlocks.TREE_SMALL.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.BEECH));
        }
