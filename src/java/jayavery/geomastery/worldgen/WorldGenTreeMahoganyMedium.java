...
// TEST
public class WorldGenTreeMahoganyMedium extends WorldGenTreeAbstract {

    public WorldGenTreeMahoganyMedium(World world, Random rand, boolean isSapling) {
...
//            case 0:
  ...
  //          case 1: default:
    ...
    private boolean generateTreeA(BlockPos stump) {
        ...
        this.setBlock(stump, GeoBlocks.BOLE_MEDIUM.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.MAHOGANY));
        
        for (BlockPos trunk : trunks) {
            
            this.setBlock(trunk, GeoBlocks.TREE_MEDIUM.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.MAHOGANY));
        }
