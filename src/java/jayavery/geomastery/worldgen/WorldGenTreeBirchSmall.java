...
// TEST
public class WorldGenTreeBirchSmall extends WorldGenTreeAbstract {

    public WorldGenTreeBirchSmall(World world, Random rand, boolean isSapling) {
  ...
  //      switch (this.rand.nextInt(3)) {
   ...
   //     }
    ...
    private boolean generateTreeA(BlockPos stump) {
        ...
        this.setBlock(stump, GeoBlocks.BOLE_SMALL.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.BIRCH));
        
        for (BlockPos trunk : trunks) {
            
            this.setBlock(trunk, GeoBlocks.TREE_SMALL.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.BIRCH));
        }
        ...
        if (this.world.getBlockState(leaf).getBlock()
            ...
            this.setBlock(leaf, GeoBlocks.LEAVES.getDefaultState().withProperty(BlockLeaves.TYPE, ETreeType.BIRCH));
        }
    ...
    private boolean generateTreeC(BlockPos stump) {
        ...
        if (this.rand.nextInt(2) == 0) {
            ...
            leaves.add(stump.up(trunkCount + 4));
        }
