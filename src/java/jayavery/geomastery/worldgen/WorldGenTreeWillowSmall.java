...
// TEST
public class WorldGenTreeWillowSmall extends WorldGenTreeAbstract {

    public WorldGenTreeWillowSmall(World world, Random rand, boolean isSapling) {
   ...
   //     }
    ...
    private boolean generateTreeA(BlockPos stump) {
        ...
        for (BlockPos trunk : trunks) {
            ...
            this.setBlock(trunk, GeoBlocks.TREE_SMALL.getDefaultState().withProperty(BlockTree.TYPE, ETreeType.WILLOW));
        }
