...
public enum ESpeedStage {
    
    SPEED_2_3(new AttributeModifier(UUID.fromString("5bbed57e-d26e-4b30-97f2-a2978d408017"), "Speed 2.3", -0.465, 1).setSaved(true)),
    SPEED_2_8(new AttributeModifier(UUID.fromString("2ae1c668-7106-4ac5-afc6-0b13229ec80f"), "Speed 2.8", -0.349, 1).setSaved(true)),
    SPEED_3_3(new AttributeModifier(UUID.fromString("da5357d3-6b7a-403d-8461-b9e40ccde30c"), "Speed 3.3", -0.233, 1).setSaved(true)),
