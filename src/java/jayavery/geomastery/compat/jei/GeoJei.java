...
public class GeoJei extends BlankModPlugin {
    ...
    public void register(IModRegistry registry) {
        ...
        if (GeoConfig.hideVanilla) {
            ...
            Set<Item> vanillaItems = Sets.newHashSet(Items.PAINTING, Items.BED,
                    ...
                    Items.EXPERIENCE_BOTTLE, Items.FIRE_CHARGE,
                    Items.WRITABLE_BOOK, Items.WRITTEN_BOOK,
                    Items.ENCHANTED_BOOK, Items.FIREWORK_CHARGE, Items.MAP,
                    Items.DIAMOND_HORSE_ARMOR, Items.GOLDEN_HORSE_ARMOR,
                    ...
                    Items.GOLDEN_APPLE, Items.FISH, Items.COOKED_FISH,
                    Items.CAKE, Items.COOKIE, Items.COMPARATOR, Items.REPEATER,
                    Items.MELON, Items.BEEF, Items.COOKED_BEEF, Items.CHICKEN,
                    ...
                    Items.COOKED_MUTTON, Items.BEETROOT_SOUP,
                    Items.DIAMOND_SHOVEL, Items.GOLDEN_SHOVEL,
                    Items.IRON_SHOVEL, Items.STONE_SHOVEL, Items.WOODEN_SHOVEL,
                    Items.DIAMOND_PICKAXE, Items.BEETROOT, Items.GOLDEN_PICKAXE,
                    ...
                    Items.IRON_HELMET, Items.LEATHER_HELMET,
                    Items.CHAINMAIL_CHESTPLATE, Items.DIAMOND_CHESTPLATE,
                    Items.GOLDEN_CHESTPLATE, Items.IRON_CHESTPLATE,
                    Items.LEATHER_CHESTPLATE, Items.CHAINMAIL_LEGGINGS,
                    Items.DIAMOND_LEGGINGS, Items.GOLDEN_LEGGINGS,
                    Items.IRON_LEGGINGS, Items.LEATHER_LEGGINGS,
                    Items.CHAINMAIL_BOOTS, Items.DIAMOND_BOOTS,
                    Items.GOLDEN_BOOTS, Items.IRON_BOOTS, Items.LEATHER_BOOTS,
                    Items.SPECTRAL_ARROW, Items.TIPPED_ARROW, Items.SHIELD,
                    Items.TOTEM, Items.GHAST_TEAR, Items.GLASS_BOTTLE,
                    Items.POTIONITEM, Items.LINGERING_POTION,
                    Items.SPLASH_POTION, Items.FERMENTED_SPIDER_EYE,
                    Items.BLAZE_POWDER, Items.MAGMA_CREAM, Items.BREWING_STAND,
                    Items.CAULDRON, Items.SPECKLED_MELON, Items.GOLDEN_CARROT,
                    Items.RABBIT_FOOT, Items.DRAGON_BREATH, Items.IRON_INGOT,
                    Items.BOWL, Items.STRING, Items.GUNPOWDER,
                    Items.WHEAT_SEEDS, Items.WHEAT, Items.CLAY_BALL,
                    Items.GLOWSTONE_DUST, Items.DYE, Items.BEETROOT_SEEDS,
                    Items.MELON_SEEDS, Items.PUMPKIN_SEEDS, Items.BLAZE_ROD,
                    Items.GOLD_NUGGET, Items.NETHER_WART, Items.NETHER_STAR,
                    Items.NETHERBRICK, Items.QUARTZ, Items.PRISMARINE_CRYSTALS,
                    Items.PRISMARINE_SHARD, Items.CHORUS_FRUIT,
                    Items.CHORUS_FRUIT_POPPED, Items.SHULKER_SHELL,
                    /* Iron nugget */ Items.field_191525_da);
            
            Set<Block> vanillaBlocks = Sets.newHashSet(Blocks.PLANKS,
                    Blocks.SPONGE, Blocks.GLASS, Blocks.WOOL,
                    Blocks.LAPIS_BLOCK, Blocks.GOLD_BLOCK, Blocks.IRON_BLOCK,
                    Blocks.STONE_SLAB, Blocks.STONE_SLAB2, Blocks.BRICK_BLOCK,
                    Blocks.BOOKSHELF, Blocks.ACACIA_STAIRS, Blocks.BIRCH_STAIRS,
                    Blocks.BRICK_STAIRS, Blocks.DARK_OAK_STAIRS,
                    Blocks.JUNGLE_STAIRS, Blocks.NETHER_BRICK_STAIRS,
                    Blocks.OAK_STAIRS, Blocks.PURPUR_STAIRS,
                    Blocks.QUARTZ_STAIRS, Blocks.RED_SANDSTONE_STAIRS,
                    Blocks.SANDSTONE_STAIRS, Blocks.SPRUCE_STAIRS,
                    Blocks.STONE_BRICK_STAIRS, Blocks.STONE_STAIRS,
                    Blocks.DIAMOND_BLOCK, Blocks.PUMPKIN, Blocks.LIT_PUMPKIN,
                    Blocks.NETHER_BRICK, Blocks.NETHER_BRICK_FENCE,
                    Blocks.NETHER_BRICK_STAIRS, Blocks.NETHER_WART_BLOCK,
                    Blocks.NETHERRACK, Blocks.RED_NETHER_BRICK,
                    Blocks.SOUL_SAND, Blocks.GLOWSTONE, Blocks.STAINED_GLASS,
                    Blocks.STONEBRICK, Blocks.MELON_BLOCK, Blocks.END_BRICKS,
                    Blocks.END_STONE, Blocks.PURPUR_SLAB, Blocks.WOODEN_SLAB,
                    ...
                    Blocks.SLIME_BLOCK, Blocks.END_ROD, Blocks.CHORUS_FLOWER,
                    Blocks.CHORUS_PLANT, Blocks.BLACK_SHULKER_BOX,
